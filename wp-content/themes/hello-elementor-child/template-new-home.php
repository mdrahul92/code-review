...
?>
       ...
       <!-- header link wrapper -->
        ...
        <!-- <section class="partner-wrapper d-flex justify-content-center py-2">
            ...
            <a href="">Restaurants: Partner with Relish! <img src="<?php echo get_stylesheet_directory_uri() ?>/images/Right Up.svg" alt=""></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-contant-wrapper">
                                ...
                                <div class="col-12 mt-4"><p class="or">Or</p></div>
